...
/******/ 	__webpack_require__.p = "/lectrum-todo-app/";
/******/
/******/
...
var _stylesM = _interopRequireDefault(__webpack_require__(173));
...
var _Spinner = _interopRequireDefault(__webpack_require__(137));
...
let App = (_dec = (0, _reactHotLoader.hot)(module), _dec(_class = class App extends _react.Component {
  render() {
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Scheduler.default, null), _react.default.createElement(_Spinner.default, null));
  }
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_createTaskAsync", async event => {
      try {
        ...
        this.setState(({
          ...
          tasks: (0, _instruments.sortTasksByGroup)([task, ...tasks]),
          newTaskMessage: ''
        }));
      } catch (error) {
        console.log(error.message);
    ...
    _defineProperty(this, "_updateTaskAsync", async updatedTask => {
      try {
        ...
        const updatedTaskFromResponse = await _REST.api.updateTask(updatedTask);
        this.setState(({
          tasks
        }) => {
          ...
          const sortedTasks = (0, _instruments.sortTasksByGroup)(newTasks);
          return {
            tasks: sortedTasks
          };
        });
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      try {
        ...
        this.setState(({
          ...
          tasks: (0, _instruments.sortTasksByGroup)(tasks.map(task => _objectSpread({}, task, {
            completed: true
          })))
        }));
      } catch (error) {
  ...
  render() {
    ...
    const todoList = tasks.filter(task => task.message.toLowerCase().includes(tasksFilter)).map(props => _react.default.createElement(_Task.default, _extends({
    ...
    return _react.default.createElement("section", {
      ...
      className: _stylesM.default.test
    }, "\u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447"), _react.default.createElement("input", {
      placeholder: "\u041F\u043E\u0438\u0441\u043A",
      type: "search",
      value: tasksFilter,
...
var _api = __webpack_require__(165);
...
const api = {
  ...
  async completeAllTasks(tasks) {
    ...
    for (const task of tasks) {
      promises.push(fetch(_config.MAIN_URL, {
        method: 'PUT',
        headers: {
          Authorization: _config.TOKEN,
          'Content-Type': 'application/json'
...
var _classnames = _interopRequireDefault(__webpack_require__(167));
...
var _Edit = _interopRequireDefault(__webpack_require__(171));

var _Star = _interopRequireDefault(__webpack_require__(172));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "taskInput", (0, _react.createRef)());
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.bbb3b.js.map